                      ...
                      onPress={async () => {
                        try {
                          ...
                          if (action !== DatePickerAndroid.dismissedAction) {
                            ...
                            for (
                              let i = 0;
                              i < this.state.HappyThings.length;
                              i++
                            ) {
                              if (
                                this.dateEqual(
                                  new Date(year, month, day),
                                  this.state.HappyThings[i][0],
                                )
                              ) {
                      ...
                      <CardItem style={styles.checkList}>
                        <CheckBox
                          ...
                          onPress={() => {
                            ...
                            item[1] = totHappy;
                            this.setState({
                              HappyThings: this.state.HappyThings,
                            });
                            setStorage(
                              'HappyThings',
                              JSON.stringify(this.state.HappyThings),
                            );
                            this.updateTotHappy();
                          }}
                        />
                            ...
                            <View style={styles.newDateModal}>
                              ...
                              <ListItem>
                                ...
                                <Picker
                                  ...
                                  onValueChange={this.onTypeValueChange.bind(
                                    this,
                                  )}>
                                  {Object.keys(this.state.Type).map(
                                    (obj, idx) => (
                                      <Picker.Item
                                        style={{justifyContent: 'center'}}
                                        label={this.state.Type[obj].name}
                                        value={this.state.Type[obj].type}
                                      />
                                    ),
                                  )}
                                </Picker>
                              ...
                              <ListItem>
                                ...
                                <Picker
                                  ...
                                  onValueChange={this.onValValueChange.bind(
                                    this,
                                  )}>
                                  <Picker.Item
                                    label="0"
                                ...
                                <Button
                                  ...
                                  onPress={() => {
                                    ...
                                    for (
                                      let i = 0;
                                      i <
                                      this.state.HappyThings[index][2].length;
                                      i++
                                    ) {
                                      if (
                                        this.state.HappyThings[index][2][i]
                                          .name === items.name
                                      ) {
                                        this.setState({
                                          HappyThings: this.state.HappyThings,
                                        ...
                                        ).then(this.setState({setVisible: -1}));
                                      }
                                    }
                                  }}>
                                  <Icon name="trash" />
                                  ...
                                  onPress={() => {
                                    ...
                                    while (
                                      ...
                                      if (
                                        ...
                                        this.state._name ===
                                        this.state.HappyThings[index][2][i].name
                                      ) {
                                        alert(
                                          '名称重复，你在这一天已经记录过一次这件幸福的事情了...',
                                        );
                                      }
                                      i++;
                                    }
                      ...
                      <View>
                        ...
                        <View style={styles.newDateModal}>
                          ...
                          <ListItem>
                            <Item
                              floatingLabel
                              style={{underlineColor: 'transparent'}}>
                              <Label>事件名称</Label>
                              <Input
                                value={this.state._name}
                                onChangeText={text => {
                          ...
                          <View>
                            <Button
                              ...
                              onPress={() => {
                                let i = 0;
                                while (
                                  i < this.state.HappyThings[index][2].length
                                ) {
                                  if (
                                    this.state._name ===
                                    this.state.HappyThings[index][2][i].name
                                ...
                                if (this.state._default) {
                                  for (
                                    let i = 0;
                                    i < this.state.defaultList.length;
                                    i++
                                  ) {
                                    if (
                                      this.state._name ===
                                      this.state.defaultList[i].name
                                    ) {
                                      if (
                                        this.state._type !==
                                          this.state.defaultList[i].type ||
                                        this.state._val !==
                                          this.state.defaultList[i].val
                                      ) {
                                        alert(
                                          '默认列表中已经有这件让你幸福的事情了~',
                                        );
                                  ...
                                  setStorage(
                                    'defaultList',
                                    JSON.stringify(this.state.defaultList),
                                  );
                                }
                                item[2].push({
                                  name: this.state._name,
        ...
        <Modal
          ...
          <View>
            ...
            <View style={styles.newDateModal}>
              ...
              <ListItem>
                <CheckBox
                  checked={this.state.useDefaultPlan}
                  onPress={() =>
                  ...
                  onPress={() => {
                    ...
                    while (i < this.state.HappyThings.length) {
                      if (
                        ...
                        this.state.chosenDate >
                        new Date(this.state.HappyThings[i][0])
                      ) {
                        break;
                      }
                      i++;
                    ...
                    if (true === this.state.useDefaultPlan) {
                      ...
                      list.splice(i, 0, [this.state.chosenDate, 0, []]);
                      this.setState({HappyThings: list});
                    }
                    //存储数据
                    setStorage(
